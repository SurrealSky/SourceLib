...
public:
	static char* CommonAlloc(const SurrealMemMgr::MemAllocType,const DWORD dwSize);
	static void CommonDeallocate(const SurrealMemMgr::MemAllocType,char *p,const DWORD dwSize=0);
};