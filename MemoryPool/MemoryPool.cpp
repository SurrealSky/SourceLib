...
char* SurrealMemMgr::CommonAlloc(const MemAllocType _type,const DWORD dwSize)
{
	return MemManager::CommonAlloc(_type,dwSize);
}
void SurrealMemMgr::CommonDeallocate(const MemAllocType _type,char *p,const DWORD dwSize)
{
